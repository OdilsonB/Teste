...
function atualizarCarrinho() {  /* FUNÇÃO (BOTÃO) ATUALIZAR CONTEÚDO DO CARRINHO */
  ...
  const total = carrinho.reduce((total, produto) => total - ( total * (0.05 * produto.preco), 0))


  if(total > 1000.00){   /* CRIA UMA CONDIÇÃO ESPECÍFICA PARA CONCEDER DESCONTO NO VALOR DA COMPRA ACIMA DE R$:1000.00*/
